...
********************************************************************************
	...
	// Overall significance and Number of observetions 
		...
		*Treatment effects
		...
		table (command) (result), `command'   : ttest Emz_`outcome'_1_1==Emz_`outcome'_4_1 ) `command'   : ttest Emz_`outcome'_1==Emz_`outcome'_4 ) `command'   : ttest Emz_`outcome'_2_2==Emz_`outcome'_4_2 ) `command'  : ttest Emz_`outcome'_2==Emz_`outcome'_4 )  `command'   : ttest Emz_`outcome'_3_3==Emz_`outcome'_4_3 ) `command'   : ttest Emz_`outcome'_3==Emz_`outcome'_4 )
		...
		foreach outcome in h {
			
		local command  "command( Use= r(mu_1)  Non_Use= r(mu_2) (Difference =r(mu_1)-r(mu_2)) pvalue = r(p)"
		table (command) (result), `command'   : ttest Emz_`outcome'_1_1==Emz_`outcome'_4_1, unpaired ) `command'   : ttest Emz_`outcome'_1==Emz_`outcome'_4 , unpaired ) `command'   : ttest Emz_`outcome'_2_2==Emz_`outcome'_4 , unpaired ) `command'  : ttest Emz_`outcome'_2==Emz_`outcome'_4_2, unpaired )  `command'   : ttest Emz_`outcome'_3_3==Emz_`outcome'_4 , unpaired ) `command'  : ttest Emz_`outcome'_3==Emz_`outcome'_4_3 , unpaired )
...
**#PART 5: Unconditional Average treatment effects  (ATU)
		...
		table (command) (result),   `command'   : ttest Emz_p_3==Emz_p_4 ) `command'   : ttest Emz_p_1==Emz_p_4 ) `command'   : ttest Emz_p_2==Emz_p_4 ) ///
		`command'   : ttest Emz_f_3==Emz_f_4 ) `command'   : ttest Emz_f_1==Emz_f_4 ) `command'   : ttest Emz_f_2==Emz_f_4 ) ///
		`command'   : ttest Emz_h_3==Emz_h_4 ) `command'   : ttest Emz_h_1==Emz_h_4 ) `command'   : ttest Emz_h_2==Emz_h_4 )
...
**#PART 6: Average treatment effects on the Treated  (ATT)
		...
		table (command) (result),   `command'   : ttest Emz_p_3_3==Emz_p_4_3 ) `command'  : ttest Emz_p_1_1==Emz_p_4_1 ) `command'   : ttest Emz_p_2_2==Emz_p_4_2 ) ///
		`command'   : ttest Emz_f_3_3==Emz_f_4_3 ) `command'   : ttest Emz_f_1_1==Emz_f_4_1 ) `command'   : ttest Emz_f_2_2==Emz_f_4_2 ) ///
		`command'   : ttest Emz_h_3_3==Emz_h_4_3 ) `command'   : ttest Emz_h_1_1==Emz_h_4_1 ) `command'   : ttest Emz_h_2_2==Emz_h_4_2 )
...
**#PART 7: Heterogeniety effects
		...
		table (command) (result),   `command'   : ttest Emz_p_2_3==Emz_p_1_3 ) `command'  : ttest Emz_p_2_1== Emz_p_3_1 ) `command'   : ttest Emz_p_1_2== Emz_p_3_2 ) ///
		`command'   : ttest Emz_f_2_3==Emz_f_1_3 ) `command'  : ttest Emz_f_2_1== Emz_f_3_1 ) `command'   : ttest Emz_f_1_2== Emz_f_3_2 ) ///
		`command'   : ttest Emz_h_2_3==Emz_h_1_3 ) `command'  : ttest Emz_h_2_1== Emz_h_3_1 ) `command'   : ttest Emz_h_1_2== Emz_h_3_2 ) 
